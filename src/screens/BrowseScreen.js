...
import { Block, Text, Button, Card, Badge } from '../elements/Index';
...
class BrowseScreen extends React.Component {
  ...
  render() {
    return (
      <Block>
        {this.renderHeader()}  {/* Header at the top */}
        {this.renderTab()}    {/* Tabs below the header */}
      </Block>
    );
  }
...
const styles = StyleSheet.create({
  header: {
    paddingHorizontal: theme.sizes.base * 2,  // Adds left/right padding
    paddingTop: theme.sizes.base * 2,        // Moves header down
    paddingBottom: theme.sizes.base,         // Adds spacing below header
