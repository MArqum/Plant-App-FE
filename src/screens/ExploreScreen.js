...
import {Block, Text, Input, Button} from '../elements/Index';
...
class ExploreScreen extends React.Component {
  ...
  renderImage = (image, index) => {
    let source = typeof image === 'string' ? { uri: image } : image;
  
    return (
      <TouchableOpacity key={`img-${index}`} onPress={() => this.onImageClicked()}>
